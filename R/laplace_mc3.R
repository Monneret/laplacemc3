...
laplace_mc3<-function(ss,initial=initial=sampleBN(n=ss$p,maxNumberParents=3),itermax=5000,burnin=1000,maxParents=ss$p-1,constraintT=t(matrix(0,ss$p,ss$p)),verbose=TRUE){
